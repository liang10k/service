...
const (
	...
	ES_URL      = "http://35.227.56.197:9200" // GCE
	BUCKET_NAME = "mtoasf-post-image"         //GCS
)
...
func main() {
	...
	createIndexIfNotExist() // create the Elactis Search connection
...
func saveToGCS(r io.Reader, bucketName, objectName string) (*storage.ObjectAttrs, error) {
	...
	client, err := storage.NewClient(ctx, option.WithCredentialsFile("/Users/mtoasf/Desktop/CloudKey/Around-890d77a46e42.json"))
